package com.vinaylogics.playwithjava.springbootlearn.springreactive.controllers;
...
class FluxAndMonoControllerTest {
    ...
    @Test
    public void test_fluxApproach1() {
    ...
    @Test
    public void test_fluxApproach2(){
    ...
    @Test
    public void test_fluxApproach3(){
    ...
    @Test
    public void test_fluxApproach4(){
        List<Integer> expectedIntegerList = Arrays.asList(1,2,3,4);
        webTestClient.get().uri("/flux")
                .accept(MediaType.APPLICATION_JSON)
                .exchange()
